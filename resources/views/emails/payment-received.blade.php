                                    ...
                                    <table class="logo" width="100%" cellpadding="0" cellspacing="0" border="0">
                                        <tbody>
                                            ...
                                            <tr>
                                                <td valign="top" align="center">
                                                    <a href="#"
                                                        ...
                                                        <img alt=""
                                                            src="cid:910c44f3a50a0fed37ddb57b2b85a140@127.0.0.1"
                                                            class="m-brand__logo-desktop" height="40" width="40"
                                                            border="0" />
                                            ...
                                            <tr>
                                                <td align="center">
                                                    <span
                                                        style="color:#48545d;font-size:22px;line-height: 24px;"></span>
                                                </td>
                                            </tr>
                                        </tbody>
                                    </table>
                                                        ...
                                                        <tbody>
                                                            <tr>
                                                                <td align="center" valign="bottom" colspan="2"
                                                                    cellpadding="3">
                                                                    <img alt="TRS" width="80"
                                                                        src="{{ url('/assets/img/therightsoftware.png') }}" />
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <td height="30" &nbsp;=""></td>
                                                            ...
                                                            <tr>
                                                                <td height="24" &nbsp;="">
                                                                    ...
                                                                    payment processed.
                                                                    <br><br>
                                                                    The Payment details are right below:
                                                                    <span class="border"></span>
                                                                    Invoice # : {{ $invoice_number }}
                                                                    <span class="border"></span>
                                                                    Date : {{ $payment_date }}<br>
                                                                    Amount : {{ $received_amount }} {{ $currency }}
                                                                    <span class="border"></span>
                                                                    <br><br><br>
                                                                    ...
                                                                    <br><br>
                                                                    Khuram Javaid
                                                                    CEO - The Right Software
                                                                    <br><br>
                                                                    https://therightsw.com/
                                                                    email: hello@therightsw.com | skype: khuram.javaid
                                                                    <br><br>
                                                                    Software Solutions | Mobile Apps | eCommerce
                                                                </td>
                                                            </tr>
                                            ...
                                            <tr>
                                                <td valign="top" align="center"> <span
                                                        ...
                                                        <a href="https://www.coinbase.com/" target="_blank"
                                                            style="color:#9EB0C9 !important; text-decoration:none;">CMS</a>
                                                        2020
                                                    </span>
