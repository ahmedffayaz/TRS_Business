    <div class="card mb-0">
        <div class="card-header mb-2 justify-content-around" style="background-color: #F8F8F8;">
                <div>
                    <a href="#" class="brand-logo" style="margin-bottom: 0.8rem;">
                        <img src="{{ cmsLogo() }}" alt="" height="50">
                    </a>
                    <h6 class="card-title text-center">{{ cmsName() }}</h6>
                </div>
                <div>
                    <a href="#" class="brand-logo" style="margin-bottom: 0.8rem;">
                        <img src="{{ asset($logo) }}" alt="" height="50">
                    </a>
                    <h6 class="card-title text-center text-capitalize">{{ $business_name }}</h6>
                </div>
                {{-- <h4 class="card-title mb-1 text-center text-capitalize">Project name:{{ $project_name }}</h4> --}}
        </div>
        <div class="card-body">
            ...
            <form class="auth-login-form mt-2" wire:submit.prevent="submit">
                ...
                <div class="row">
                    <div class="col-md-6 mb-1">
                        <input type="text" class="form-control @error('form.first_name') is-invalid @enderror"
                            id="first_name" name="first_name" wire:model="form.first_name" placeholder="First Name"
                    ...
                    <div class="mb-1 col-md-6">
                        <input type="text" class="form-control @error('form.last_name') is-invalid @enderror"
                            id="last_name" name="last_name" wire:model="form.last_name" placeholder="Last Name"
                ...
                <div class="mb-1">
                    <input type="email" class="form-control @error('form.email') is-invalid @enderror" id="email"
                        name="email" wire:model="form.email" placeholder="Email" aria-describedby="email"
                        tabindex="6" />
                    @error('form.email')
                        <small class="text-danger">{{ $message }}</small>
                    @enderror
                ...
                <div class="mb-1">
                    <div class="input-group input-group-merge form-password-toggle">
                        <input type="password"
                            class="form-control form-control-merge @error('form.password') is-invalid @enderror"
                            wire:model="form.password" id="password" name="password" tabindex="7"
                ...
                <div class="mb-1">
                    <div class="input-group input-group-merge form-password-toggle">
                        <input type="password"
                            ...
                            name="password_confirmation" tabindex="8" placeholder="Confirm Password"
                ...
                <button class="btn btn-primary w-100 mt-1 mb-2" tabindex="9" wire:loading.attr="disabled">
            ...
            <div class="d-flex justify-content-between align-items-center">
                <a href="javascript:void(0)" wire:click="redirectToLogin" >
