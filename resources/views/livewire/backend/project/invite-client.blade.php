...
<div class="row mt-1 mb-1">
    ...
    <div class="col-md-3">
        <button class="btn btn-primary" wire:click="sendInvitationByEmail('{{ $slug }}')">Share</button>
    </div>
</div>
<div class="row mb-2">
    <div class="col-md-12 d-flex align-items-start gap-1 pt-1">
        <div
        ...
        <p style="line-height: 1;">
            Share this link with the project members to join as a client
            under @isset($client_name)
            ...
            @if ($generatedLink)
                ...
                <a href="javascript:void(0)" wire:click="deleteLink('{{ $slug }}')"
                    class="text-danger fw-bold">Delete link</a>
            @else
                <a href="javascript:void(0)" wire:click="generateLink('{{ $slug }}')"
                    class="text-primary fw-bold">Create link</a>
            @endif
        </p>
    </div>
</div>
