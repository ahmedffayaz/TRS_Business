        ...
        <div class="card-header">
            ...
            <div>
                <x-anchor-tag href="#" class="btn btn-primary float-end" tabindex="0" aria-controls="table-hover"
                    type="button" wire:click="openModal" value="Add Leave" />
            </div>
            @endcan
        </div>
                        ...
                        @isset($leaves)
                            @forelse ($leaves as $leave)
                                ...
                                <tr>
                                    ...
                                    {{-- <td>{{ $leave->reason }}</td> --}}
                                    <td>
                                        <span class="badge rounded-pill badge-light-{{ leaveStatus($leave?->status) }}">{{
                            ...
                            @empty
                                <tr class="no-hover">
                                    <td colspan="8" class="text-center py-1 fw-bold"><p>No Leave Found</p></td>
                                </tr>
                            @endforelse
                        @endisset
                    </tbody>
