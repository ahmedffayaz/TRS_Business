                                            ...
                                            <div class="col-12 d-flex product-details-border position-relative pe-0">
                                                <div class="row w-100 pe-lg-0 pe-1 mt-2">
                                                    <div class="col-lg-5 mb-lg-0 mb-2 mt-lg-0 mt-2">
                                                        ...
                                                        <input type="text" id="country" name="task"
                                                    ...
                                                    @if ($task->project->type->name === 'hourly')
                                                    <div class="col-lg-2 col-12 my-lg-0 my-2">
                                                        <p class="card-text col-title mb-md-2 mb-0">Rate Per Hour</p>
                                                        <input type="hidden" class="form-control task_amount" aria-label=""
                                ...
                                <div class="col-md-6 d-flex align-items-start justify-content-end">
                                    <div class="invoice-total-wrapper">
                                        <div class="invoice-total-item">
                                            ...
                                            <x-input type="number" name="deduction" id="deduction"
...
@script
    <script type="module">
        ...
        let adjustmentTotal = 0; // Added to track adjustment amounts
...
function recalculateTotals(unit = '') {
    ...
    // Get the project unit from the first task (assuming they all use the same unit)
    var dataUnit = unit || $('.generic-amount').first().data('unit') || 'USD';

    // Update total amount and display
    @this.set('invoiceForm.total_amount', sum);
    $('.total-cost').text(formatCurrency(taskGenericTotal, dataUnit));
}
