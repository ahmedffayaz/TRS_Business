...
<div class="container">
    <div class="row">
        ...
        <div class="col-sm-12 col-md-6 col-lg-4 mb-3"> <!-- Adjust column width for different screen sizes -->
            <div class="card h-100 position-relative">
                <div class="card-body d-flex align-items-center">
                    <div class="avatar me-3">
                        <img src="{{ asset('storage/' . $business->logo) }}" class="rounded-circle" width="60" height="60" alt="Avatar" onerror="_business_logo(this)" />
                    </div>
                    <div class="">
                ...
                <div class="dropdown position-absolute top-0 end-0 my-1 ">
                    ...
                    <div class="dropdown-menu dropdown-menu-end">
                        ...
                        @can('view_reason')
                        <x-anchor-tag class="dropdown-item" href="#"
                            wire:click="viewReason({{ $business?->id }})">
