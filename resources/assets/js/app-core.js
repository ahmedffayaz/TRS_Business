...
import Unison from '../vendors/unison-js/unison';
...
(function (window, document, $) {
  ...
  $(window).on('load', function () {
    ...
    window.Unison.on('change', function (bp) {
...
//   Waves.attach("[class*='btn-flat-']");
  ...
  //   console.log(window.matchMedia('(prefers-color-scheme: light)').matches, ' ', currentLocalStorageLayout);
